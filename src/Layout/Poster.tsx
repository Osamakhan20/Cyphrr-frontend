...
export const JobPoster = () => {
  return (
    <section className="bg-bgCard px-6 py-20">
      <div className="max-w-7xl mx-auto grid grid-cols-1 lg:grid-cols-2 gap-14 items-center">
        <div className="relative flex items-center justify-center">
          <div className="grid grid-cols-2 gap-6">
            <Person1 className="rounded-2xl w-40 h-40 object-cover" />
            <Person2 className="rounded-2xl w-40 h-40 object-cover" />
            <Person3 className="rounded-2xl w-40 h-40 object-cover col-span-2 mx-auto" />
          </div>

          <div className="absolute top-4 left-4/5 -translate-x-1/2 bg-bgCard rounded-lg flex items-center px-3 py-2 shadow-md">
            <input
              type="text"
          ...
          <div className="absolute bottom-4 left-52 -translate-x-1/2 bg-bgCard px-4 py-2 rounded-xl flex items-center gap-2 shadow-md">
